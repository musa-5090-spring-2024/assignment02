...
/*
With a query, find out how many census block groups Penn's main campus fully contains. Discuss
 which dataset you chose for defining Penn's campus.
*/
...
penn_campus as (
    select st_convexhull(st_collect(pennproperty.geog::geometry)) as geom
    from pennproperty
    inner join university_city
        on st_intersects(university_city.geog, pennproperty.geog)
)
